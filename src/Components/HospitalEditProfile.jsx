...
const HospitalEditProfile = () => {
    ...
    const callProfilePage = useCallback(async () => {
        try {
            ...
            const res = await axios.get("/hospitaldashboard",{
                headers:{
                    'jwtoken':cookieValue
                }
            });
        ...
        try {
            const res = await axios.get("/hospitalprofileimg", {responseType: 'arraybuffer' });
    ...
    const updateData = async (e) => {
        ...
        try {
            const res = await axios.post('/hospitalupdatedata', formData,{
                headers:{
