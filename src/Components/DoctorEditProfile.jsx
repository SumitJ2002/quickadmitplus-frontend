...
const DoctorEditProfile = () => {
    ...
    const callProfilePage = useCallback(async () => {
        try {
            ...
            const res = await axios.get("/doctordashboard",{
                headers:{
                    'jwtoken':cookieValue
                }
            });
        ...
        try {
            const res = await axios.get("/doctorprofileimg", {responseType: 'arraybuffer' });
    ...
    useEffect(() => {
        ...
        const fetchHospitalNames = async () => {
            try {
                const response = await axios.get('/hospitalnames');
    ...
    const updateData = async (e) => {
        ...
        try {
            const res = await axios.post('/doctorupdatedata', formData,{
                headers:{
